...
export const metadata: Metadata = {
  title: "Secuestros",
  description:
    "Secuestros de miembros del Poder Judicial y Ejecutivo, representantes extranjeros y empresarios documentados en la prensa nacional de la época. Museo de la Memoria del Pasado Reciente.",
  openGraph: {
    type: "website",
    locale: "es_UY",
    url: "https://www.pasadoreciente.com/secuestros",
    siteName: "Pasado Reciente",
    title: "Secuestros - Pasado Reciente",
    description:
      "Secuestros documentados en la prensa nacional de los años 60 y 70.",
    images: [
      {
    ...
    <main className="max-w-7xl mx-auto px-2 xs:px-4 py-6 xs:py-12 overflow-x-hidden">
      ...
      <div className="mb-4 xs:mb-8 border-b border-border pb-4 xs:pb-8 flex flex-col items-end justify-end">
        <p className="text-right max-w-full xs:max-w-2xl text-xs xs:text-base md:text-lg text-muted-foreground leading-relaxed italic">
          Secuestros de miembros del Poder Judicial y Ejecutivo, representantes
          extranjeros y empresarios documentados en la prensa nacional de la
          época.
        </p>
